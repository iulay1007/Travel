...
public class CityChooseDialog extends DialogFragment implements IDialogListCallback {
    ...
    @SuppressLint("ValidFragment")
    public CityChooseDialog(SecondFragment secondFragment) {
    ...
    private void loadData() {
        ...
        presenter.getCity(getActivity(),innerHandler);
    }
    ...
    private void initView() {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                secondFragment.updateListByCity(adapter.checkBox);
